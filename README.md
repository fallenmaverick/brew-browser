...
brew-browser makes outbound network calls in exactly eleven documented circumstances. Every one is initiated by something you did and gated by Settings → Network:
